...
console.log(sumAndProduct(3, 3, 3));
...
console.log(averageMovieReview(2, 2, 5));
...
function weightedAverageMovieReview(rachel, roger, jake) {
	total = 0.25 + 1 + 2.2;
	return (sum(sum(product(rachel, 0.25), product(roger, 1)), product(jake, 2.2)))/3;
}
console.log(weightedAverageMovieReview(2, 2, 5));
